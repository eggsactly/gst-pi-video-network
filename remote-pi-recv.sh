...
gst-launch-1.0 udpsrc \
	...
	udpsrc multicast-group=$MULTI_CAST_IP port=$BASE_AUDIO_PORT ! application/x-rtp, media=audio, clock-rate=8000, encoding-name=PCMU ! rtpjitterbuffer ! rtppcmudepay ! queue ! mulawdec ! queue ! audioconvert ! alsasink sync=false 
